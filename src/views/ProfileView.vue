...
const friends = [
  { name: "Maryann", img: maryann },
  { name: "Dorcas", img: dorcas },
  { name: "Faith", img: faith },
  { name: "Mercy", img: mercy },
  { name: "Joel", img: joel },
  { name: "Tony", img: tony },
  { name: "Jill", img: jill },
  { name: "Chidera", img: chidera },
  { name: "Ijeoma", img: ijeoma },
];
...
const posts = [
  {
    id: 1,
    content:
      "Happy birthday to my girl. I wish you the very very very best my darling",
    time: "3 days ago",
    likes: 224,
    comments: 13,
    shares: 2,
  ...
  {
    id: 2,
    content: "Congratulations on your big day Ella. You have earned this!!",
    time: "15 mins ago",
    likes: 224,
    comments: 13,
    shares: 2,
  ...
  <div class="min-h-screen bg-gray-100">
    ...
    <div class="pt-14 pb-16">
      <div class="mx-auto max-w-4xl">
        <!-- Cover Photo -->
        <div
          class="relative h-40 sm:h-72 bg-white"
          style="box-shadow: inset 0 -100px 70px -20px rgba(128, 128, 128, 0.6)"
        >
          <button
            class="absolute top-4 left-4 sm:hidden bg-white/80 text-gray-800 font-semibold px-3 py-1 rounded-lg text-sm flex items-center gap-2"
          >
            <i class="fa fa-camera"></i> Add a cover photo
          </button>
          <button
            class="hidden sm:flex absolute bottom-4 right-4 bg-white text-gray-800 font-semibold px-4 py-2 rounded-lg text-sm items-center gap-2 shadow"
          >
        ...
        <div class="sm:hidden bg-white px-4 pb-4">
          ...
          <div class="-mt-16 mb-3">
            ...
            >
              <img :src="me" class="w-full h-full object-cover" />
            </div>
          </div>

          <!-- Name & Info -->
          <h1 class="text-2xl font-bold text-gray-900">Emmanuella Ukata</h1>
          <p class="text-gray-500 text-sm mt-1">
            <span class="font-bold text-gray-800">500</span> friends
          </p>
          <p class="text-gray-700 text-sm mt-1">Child of God 😊</p>
      ...
      <div class="sm:hidden px-4 mt-4 space-y-4">
        ...
        <div class="bg-white rounded-xl shadow p-4">
          ...
          <ul class="space-y-3 text-sm text-gray-600">
            <li class="flex items-center gap-2">
              ...
              Lives in <span class="font-bold ml-1 text-gray-900">Kaduna</span>
            </li>
            <li class="flex items-center gap-2">
        ...
        <div class="bg-white rounded-xl shadow p-4">
          <div class="flex items-center gap-3">
            ...
            >
              What's on your mind, Emmanuella?
            </button>
          </div>
        </div>
          ...
          <div class="bg-white rounded-xl shadow p-4">
            ...
            <ul class="space-y-3 text-sm text-gray-600">
              <li class="flex items-center gap-2">
                ...
                Works at GreySoft Technologies
              </li>
              <li class="flex items-center gap-2">
                <i class="fa fa-graduation-cap text-gray-400 w-4"></i>
                Studied at Landmark University
              </li>
              <li class="flex items-center gap-2">
              ...
              <li class="flex items-center gap-2">
                <i class="fa fa-cake text-gray-400 w-4"></i>
                December 15
              </li>
              <li class="flex items-center gap-2">
                <i class="fa fa-heart text-gray-400 w-4"></i>
                Single
              </li>
            </ul>
            <button
        ...
        <div class="col-span-8 space-y-4">
          ...
          >
            ...
            >
              ...
              >
              <span
                >{{ post.comments }} comments · {{ post.shares }} shares</span
              >
            </div>
            <div class="flex items-center justify-around pb-2 px-2">
              <button
